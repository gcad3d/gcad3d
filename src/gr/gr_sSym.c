...
-----------------------------------------------------
TODO:
 GR_sSym_spl - Planaren Flaechen symbolisch darstellen  / 'Schraffuralg.'
...
//===========================================================================
  int GR_sSym_srus (Point *p1Tab, Point *p2Tab, int ptNr, int sTyp,
                   int att, long ind) {
//===========================================================================
...
// USING: memspc53
  ...
  // printf("GR_sSym_srus ptNr=%d sTyp=%d %d\n",ptNr,sTyp,ind);
    // GR_tDyn_npt__ (ptNr, p1Tab, SYM_TRI_S, 4);
    // GR_tDyn_npt__ (ptNr, p2Tab, SYM_TRI_S, 5);
  ...
  // printf("ex GR_sSym_srus\n");
  return 0;



  L_eom:
    TX_Error("GR_sSym_srus EOM");
    return -1;
...
//================================================================
  int GR_sSym_srv (ObjGX *oxi, int att, long ind) {
//================================================================
...
// display 3 circles starting at StartPoint/midPoint/endPoint ?
  ...
  if(cTyp == Typ_CI) {
    ...
    if(UT3D_comp2vc_d(&vca, &cii->vz, UT_TOL_min1)) {
      TX_Error("GR_sSym_srv E1-parameter-error");
      return -1;
    }
  ...
  GL_set_ox_cv (&oo);
    ...
    // printf("ex GR_sSym_srv\n");
  return 0;

  L_eom:
    TX_Error("GR_sSym_srv EOM");
    return -1;
...
//================================================================
  int GR_sSym_sbsp (SurBSpl *sur, int att, long ind) {
//================================================================
  ...
  // DEB_dump_obj__ (Typ_SURBSP, sur, "GR_sSym_sbsp:");
...
//================================================================
  int GR_sSym_srbsp (SurRBSpl *sur, int att, long ind) {
//================================================================
  ...
  // DEB_dump_obj__ (Typ_SURRBSP, sur, "GR_sSym_srbsp:");
